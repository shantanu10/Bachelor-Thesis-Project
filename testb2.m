sam=load('Libras.txt');
figure(1)
plot(sam(:,2),sam(:,3),'k*','MarkerSize',5);
title 'Libras movement';
xlabel 'Hand movement 1';
ylabel 'Hand movement 2';
...
figure(5)
scatter(data(:,1),data(:,2),10,ids,'filled');title('Clusters found by bat algorithm algorithm');axis equal;
